        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-6" style="text-align:right">
                    <button onclick="location.href='../menu.php';" style="border: 1px solid #BDBDBD;" ><img src="../img/regresar.png" height="35" width="60">  </button>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        foreach($RegistrosPedidos as $reg){
                            ...
                            echo '<td style="text-align:center"><a href="../controlador/controlador_pedido.php?opcion=5&id='.$reg['id_ped'].'"><img src="../img/eliminar.ico" width=25 height=25></a></td>';
                            echo '</tr>';
                        }
                    ?>
                </tbody>
