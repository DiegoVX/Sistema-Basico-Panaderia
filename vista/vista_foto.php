...
<html lang="es">
  <head>
    ...
    <script>
      function Registro(){
        ocation.href="../vista/vista_ing_foto.php";
      }
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-expand-lg fixed-top custom-navbar">
      ...
      <img src="../img/logo.png" class="img-fluid nav-logo-mobile" alt="Company Logo">
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <div class="container">
            <img src="../img/logo.png" class="img-fluid nav-logo-desktop" alt="Company Logo">
          ...
          <tbody>
            ...
            <?php
              ...
              foreach ($RegistroFotos as $fila){
                ...
                echo '<td><a href="../controlador/controlador_foto.php?opcion=3&id='.$fila['id_foto'] .'"><img src="../img/editar.png" width=25 height=25 ></a></td>';
                echo '<td><a href="../controlador/controlador_foto.php?opcion=5&id='.$fila['id_foto'] .'"><img src="../img/eliminar.ico" width=25 height=25 ></a></td>';
                echo '</tr>';
              }
            ?>      
          </tbody>   
  ...
  <footer>
    <br>
    Todos los derechos reservados de ITSLP - 202 | Desarrollado por: Grupo de ingeniería en Sistemas Computacionales
  </footer>
</html>
