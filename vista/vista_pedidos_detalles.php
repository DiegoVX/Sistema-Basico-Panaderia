    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-6" style="text-align:right">
                    <button onclick="window.close();" style="border: 1px solid #BDBDBD;" ><img src="../img/regresar.png" height="35" width="60">  </button>
                </div>
            </div>
        </div>
        <div class="container" style="margin-top:15px">
            ...
            <div class="row" id="btn" style="margin-top:15px;">
                <div class="col-3">
                    <button class="btn btn-primary" onclick="grabar_recojo(<?php echo $_SESSION['nro_pedido'] ?>);" >Grabar pedido</button>
                </div>
            </div>
        </div>
    </body>
