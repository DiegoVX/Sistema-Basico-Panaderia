                ...
                <tbody>
                    ...
                    <?php
                        ...
                        foreach($RegistrosRecojos as $reg){
                            ...
                            echo '<td style="text-align:center"><a href="../controlador/controlador_recojo.php?opcion=5&id='.$reg['id_recojo'].'"><img src="../img/devolución.png" width=25 height=25></a></td>';
                            echo '<td style="text-align:center"><a href="../controlador/controlador_recojo.php?opcion=5&id='.$reg['id_recojo'].'"><img src="../img/eliminar.ico" width=25 height=25></a></td>';
                            echo '</tr>';
                        }
                    ?>  
                </tbody>
