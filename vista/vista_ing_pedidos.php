            ...
            <div class="row" style="margin-top:20px">
                ...
                <div class="row" style="margin-top:10px">
                    ...
                    <div class="col-2" style="text-align:right">
                        <button onclick="location.href='../controlador/controlador_pedido.php?opcion=1';" style="border: 1px solid #BDBDBD;" ><img src="../img/regresar.png" height="35" width="60">  </button>       
                    </div>
                </div>
            <!-- Item de pedido -->
