                ...
                <tbody>
                    <?php
                        ...
                        foreach($RegistrosPanes as $reg){
                            ...
                            echo '<td style="text-align:center"><a href="../controlador/controlador_detalle.php?opcion=5&iddet='.$reg['id_det'].'"><img src="../img/eliminar.ico" width=25 height=25></a></td>';
                            echo '</tr>';
                            $tot=$tot+ $reg['imp_pan'];
                        }
                    ?> 
