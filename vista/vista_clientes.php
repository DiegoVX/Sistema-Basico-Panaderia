            ...
            <?php
                //La estructura foreach trabaja con colecciones o arreglos
                    foreach($registros as $reg){
                        ...
                        echo '<td style="text-align:center"><a href="../Controlador/controlador_cliente.php?opcion=3&id='.$reg['id_cliente'].'"><img src="../img/editar.png" width=25 height=25></a></td>';
                        echo '<td style="text-align:center"><a href="../Controlador/controlador_cliente.php?opcion=5&id='.$reg['id_cliente'].'"><img src="../img/eliminar.ico" width=25 height=25></a></td>';
                        echo '</tr>';
                    }
            ?> 
